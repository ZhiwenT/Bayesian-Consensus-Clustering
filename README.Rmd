...
GA <- knitr::kable(fit.BCC$summary.stat$GA, caption = "GA") #fixed effect coefficients
add_header_above(GA, c("first marker (lbili)" = 1, "second marker (lsgot)" = 1, "third marker (spider)" = 1))
